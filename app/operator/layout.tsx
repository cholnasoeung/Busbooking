...
export default function OperatorLayout({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-stone-950 via-stone-900 to-stone-950 text-white">
      <div className="mx-auto flex min-h-screen max-w-[1200px] flex-col gap-6 px-4 py-6 lg:flex-row">
        <aside className="rounded-[32px] border border-white/10 bg-white/5 p-6 shadow-[0_40px_60px_rgba(15,23,42,0.6)] lg:w-72">
